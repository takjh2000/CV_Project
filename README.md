...
대중교통 이용이 상대적으로 어려운 상황에서 차량 이용은 필수적이며, 전용 주차구역의 부정 이용은 실제 이용자의 접근을 직접적으로 방해합니다.
...
기존 시스템은 1번에는 비교적 강하지만, 2번에 대한 직접적인 판단 근거를 제공하지 못합니다.

본 프로젝트는 개인정보(신원, 얼굴, 번호판)가 아닌 **보행 패턴이라는 행동 정보**에 기반하여 단속을 보조할 수 있는 새로운 판단 기준을 제안합니다.
